...
import { canConfirmArchive } from "@/lib/adminArchive";
...
export default function AdminContent() {
  ...
  const archive = trpc.content.archivePublic.useMutation({ onSuccess: async () => { await refresh(); setArchiveTargetId(null); toast.success("أُزيل المحتوى من المحتوى العام."); }, onError: error => toast.error(error.message) });
