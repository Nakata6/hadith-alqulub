...
export const ONBOARDING_STEPS: OnboardingStep[] = [
  ...
  { id: "tip", screen: "game", targetSelector: '[data-tour="tip"]', title: "نصيحة في وقتها", body: "افتحا نصيحة واحدة من مصادرها في الوقت الذي يناسبكما، من دون إغراق شاشة اللعب بقائمة طويلة.", placement: "bottom" },
  ...
  { id: "tools", screen: "game", targetSelector: '[data-tour="session-tools"]', title: "أدوات الجلسة", body: "من هنا تتابعان إحصائيات الجلسة. أمّا سجل النصائح وفلترتها فهما أدوات إدارة تحافظ على بساطة تجربة اللعب.", placement: "top" },
